    ...
    <div className="product-container">
      ...
      <div className="top-bar">
        <input
          ...
          className="search-bar"
        />
        <div className="profile-icon" onClick={() => alert("Profile clicked (demo)")}>
          <img
            src="https://cdn-icons-png.flaticon.com/512/1144/1144760.png"
            alt="Profile"
            style={{ width: 32, height: 32, cursor: 'pointer' }}
      ...
      <div style={{ margin: '20px 0', display: 'flex', gap: '10px' }}>
        <button 
          onClick={() => {
            ...
            "user_id": "18f716ac-37a4-464f-adb7-3cc30032308c",
            "timestamp": "2025-12-02T09:35:18.965Z",
            "context": {
                "group_id": "ac8db7ba-5139-4911-ba6e-523fd9c4704b"
            }
          }]);
        ...
        "properties": {
          ...
          "user_id": "18f716ac-37a4-464f-adb7-3cc30032308c",
          "timestamp": "2025-12-10T10:21:08.733Z",
          "context": {
              "group_id": "ac8db7ba-5139-4911-ba6e-523fd9c4704b"
          }
          }]);*/
      ...
      <div className="movie-section">
        <h2>{searchQuery ? '🔍 Search Results' : '🎬 All Movies'}</h2>
        <div className="movie-list">
          {filteredMovies.map((movie, index) => (
            <div className="movie-card" key={index}>
              <img src={movie.image} alt={movie.title} />
