...
//     {
//       title: "The Cosmic Journeys",
//       img: "https://m.media-amazon.com/images/M/MV5BNjA5NDk0Nzk1OF5BMl5BanBnXkFtZTgwMjk1NjE0MzE@._V1_FMjpg_UX1000_.jpg"
//     },
...
//         <p>
//           At CineStream, we are passionate about bringing the world's best cinematic experiences to your screen.
//           Our mission is to provide unlimited entertainment with unparalleled quality and convenience.
//         </p>
//       </section>
...
export default function MovieStreamPage() {
  ...
  const sections = {
    ...
    moreReasons: useRef(null),
    trendingMovies: useRef(null),
    pricing: useRef(null),
    about: useRef(null),
    faq: useRef(null),
  };
  ...
  return (
    <div className="page-container">
      {/* Hero Section */}
      <section id="hero" ref={sections.hero} className="hero-section">
        <h1>Introducing CineStream 🎬</h1>
        <p>Your ultimate destination for endless entertainment. Stream movies and shows anytime, anywhere!</p>
        <button onClick={handleGetStartedClick}>Get Started</button>
      </section>

      {/* Product Overview */}
      <section id="product-overview" ref={sections.productOverview} className="product-overview-section">
        <img
          src="https://picsum.photos/id/1015/800/600"
          alt="CineStream Interface"
          className="product-image"
      ...
      {/* More Reasons to Join */}
      <section id="more-reasons" ref={sections.moreReasons} className="more-reasons-section">
        <h2>More Reasons to Love CineStream ❤️</h2>
        <div className="reasons-grid">
          <div className="reason-card">
            <h3>Enjoy on your TV 📺</h3>
      ...
      {/* Trending Movies */}
      <section id="trending-movies" ref={sections.trendingMovies} className="trending-movies-section">
        <h2>Now Trending 🔥</h2>
        <div className="movie-grid">
          {trendingMovies.map((movie, i) => (
            <div key={i} className="movie-card">
      ...
      {/* Pricing */}
      <section id="pricing" ref={sections.pricing} className="pricing-section">
        <h2>Simple, Transparent Pricing</h2>
        <div className="pricing-grid">
          <div className="pricing-card">
            <h3>Standard</h3>
      ...
      {/* About */}
      <section id="about" ref={sections.about} className="about-section">
        <h2>About CineStream</h2>
        <p>
          At CineStream, we are passionate about bringing the world's best cinematic experiences to your screen.
          Our mission is to provide unlimited entertainment with unparalleled quality and convenience.
      ...
      {/* FAQ */}
      <section id="faq" ref={sections.faq} className="faq-section">
        <h2>Frequently Asked Questions</h2>
        <div className="faq-content">
          <div className="faq-item">
            <strong>Is there a free trial?</strong>
          ...
          <div className="faq-item">
            <strong>What devices are supported?</strong>
            <p>
              CineStream is available on smart TVs, game consoles, streaming media players, mobile devices, and
              web browsers.
            </p>
          </div>
        </div>
